	...
	<div class="row">
		<div class="span12">
			...
			<div id="new_review" class="collapse in">
					...
					<div class="row">
						<div class="span12">
					<strong>Rviewed Status: </strong><br><select name="reviewed_status" class="combobox">
						...
						<?php } ?>
                                        ...
                                        <div class="row">
                                                <div class="span12">
                                        <strong>Audit Status: </strong><br><select name="audit_status" class="combobox">
                                                <?php foreach ($audit_types as $rt) { ?>
                                                        <option value="<?php echo $rt ?>" <?php if ($row['audit_status'] == $rt) { echo ' SELECTED '; } ?>><?php echo $rt ?></option>
                                                <?php } ?>
                                        </select><br>
